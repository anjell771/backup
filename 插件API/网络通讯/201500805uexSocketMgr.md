...
# 3、更新历史
API 版本：uexSocketMgr-3.0.4(iOS) uexSocketMgr-3.0.3（Android）
最近更新时间：2015-06-19

|  历史发布版本 | iOS更新  | 安卓更新  |
| ------------ | ------------ | ------------ |
| 3.0.4 |  调整onData方法的回调参数 |   |
| 3.0.3  | 修复问题 | 修改直接点击发送DUP或发送TCP系统崩溃问题  |
| 3.0.2  | 修复问题 | 修改onData回调方法的参数  |
| 3.0.1  |  修复问题   | 修复内部检测网络状态的bug，添加组播地址的配置|
| 3.0.0  | Socket功能插件  | Socket功能插件|
