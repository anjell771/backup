...
| 3.0.3  |  uexUploaderMgr插件新增setHeaders接口 | 替换插件中引擎包及新增必要资源文件  |
| 3.0.2  |  修复uexUploaderMgr.uploadFile接口不传"可选"参数会奔溃的bug | 新增setHeaders方法  |
| 3.0.1  | 修复上传过程中关闭window崩溃问题  |  修改UPLOAD上传慢问题|
| 3.0.0  | 上传功能插件  | 上传功能插件|